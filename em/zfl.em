...
macro ExpandProcCN(szMyName,wordinfo,szLine,szLine1,nVer,ln,sel)
{
	...
	else if(szCmd == "fu" || szCmd == "func")
	{
		...
		InsBufLine(hbuf, ln + 2, " *@@params :")
		InsBufLine(hbuf, ln + 3, " *")
		InsBufLine(hbuf, ln + 4, " *@@return :")
		InsBufLine(hbuf, ln + 5, " *")
		InsBufLine(hbuf, ln + 6, " *@@author : @szMyName@")
		InsBufLine(hbuf, ln + 7, " *@@email  : 460342522@@qq.com")
		SysTime = GetSysTime(1)
        szYear=SysTime.Year
        szMonth=SysTime.month
        szDay=SysTime.day
		InsBufLine(hbuf, ln + 8, " *@@date   : @szYear@-@szMonth@-@szDay@")
		InsBufLine(hbuf, ln + 9, " *")
		InsBufLine(hbuf, ln + 10, " */")
		InsBufLine(hbuf, ln + 11, "")
		SetBufIns (hbuf, ln + 11, 0)
		return
	}
